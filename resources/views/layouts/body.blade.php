...
<div class="container clearfix">
	...
	<div class="header-container">					
		<h1>WELCOME TO ALIVE-NIGERIA MEMBERSHIP AND REGISTRATION PORTAL</h1>
	</div>
	...
	<p> 
		...
		Jesus Christ.
			...
			<div> 
			<a href="{{route('registration')}}" class="button button-border button-green button-rounded button-large ms-0 topmargin-sm">Check Your Eligibility</a>
					</div>
				</div>
			</div>
</div>
